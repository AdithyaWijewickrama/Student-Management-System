...
public final class User_login extends javax.swing.JFrame {
    ...
    public User_login() {
        ...
        user.setIcon(Commons.getImage(School.PROFIMAGE_ROUND, user.getHeight(), user.getHeight()));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int act = new ChangePasswordOption().getAction();
    ...
    private void passwordFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_passwordFocusGained
        if (!jPanel4.getBackground().equals(UI.getTransparentColor())) {
            Color c = UI.getTransparentColor();
            focus(c);
            validate();
            repaint();
        }
