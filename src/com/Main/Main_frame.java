...
import com.SystemSecurity.User_login;
...
//                new Loader(jProgressBar1).start();
        ...
        user.setIcon(Commons.getImage(School.PROFIMAGE_ROUND, 40, 40));
    ...
    private void initComponents() {
        ...
        jScrollPane1.setMaximumSize(new java.awt.Dimension(450, 300));
        ...
        jScrollPane2.setMaximumSize(new java.awt.Dimension(450, 300));
                    ...
                    .addGroup(jDialog1Layout.createSequentialGroup()
                        ...
                        .addGroup(jDialog1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jDialog1Layout.createSequentialGroup()
                                .addGroup(jDialog1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jDialog1Layout.createSequentialGroup()
                                        ...
                                        .addGap(49, 49, 49)
                                        .addComponent(scl_name, javax.swing.GroupLayout.DEFAULT_SIZE, 392, Short.MAX_VALUE))
                                    .addGroup(jDialog1Layout.createSequentialGroup()
                            ...
                            .addGroup(jDialog1Layout.createSequentialGroup()
                                ...
                                .addGap(13, 13, 13)
                                .addComponent(scl_email, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(20, 20, 20)
                                .addComponent(jLabel117)
                                .addGap(19, 19, 19)
                                .addComponent(scl_emailpsw, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(10, 10, 10))))
        ...
        setTitle("Student Management System - My soft");
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(Message, javax.swing.GroupLayout.DEFAULT_SIZE, 501, Short.MAX_VALUE)
                .addGap(202, 202, 202)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(boxPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 556, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPanel10, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
            .addComponent(jScrollPane13, javax.swing.GroupLayout.DEFAULT_SIZE, 641, Short.MAX_VALUE)
        );
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        if (t == 0) {
            ...
            this.dispose();
            User_login user_login = new com.SystemSecurity.User_login("Light");
        }
...
//        selectFrame(Analyze_frame);
    ...
    private void jMenuItem8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem8ActionPerformed
        try {
            openFile("Student Management System-My Soft Documentation.pdf");        // TODO add your handling code here:
...
//        }
    ...
    public static String getDecrypted(String str, String id) {
        ...
        String[] c = new String[str.toCharArray().length];
        for (int i = 0; i < c.length; i++) {
            c[i] = Character.toString(str.toCharArray()[i]);
        }
        for (int i = 0; i < c.length; i++) {
            switch (c[i]) {
                case "$":
    ...
    private void userMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_userMouseClicked
        UI.genarateCenter(jDialog1, 500, 500);
        jDialog1.setVisible(true);
        jLabel5.setIcon(Commons.getImage(School.PROFIMAGE_ROUND, jLabel5.getHeight(), jLabel5.getHeight()));
        ...
        school_image.setIcon(School.Image);
