...
public class Student implements StudentDetails {
    ...
    public Student(String id) {
        ...
        try {
            this.birth = new SimpleDateFormat("yyyy-mm-dd").parse(all.get(5).toString());
    ...
    public static Object getDateAdded(String id) {
        return Sql.getValue("SELECT Date FROM date_added WHERE ID='" + id + "'", DBconnect.CONN);
    }

    public static Object getLatestUpdate(String id) {
        return Sql.getValue("SELECT Date FROM last_update WHERE ID='" + id + "'", DBconnect.CONN);
    }
