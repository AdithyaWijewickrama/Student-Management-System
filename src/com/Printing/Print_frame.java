    ...
    private void initComponents() {
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(jCheckBox13)
                .addGap(5, 5, 5)
                .addComponent(jPanel22, javax.swing.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
                .addGap(16, 16, 16))
        );
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Marks Report(Single)", "Marks Report(Multiple)", "ID Card", "Students Detailes" }));
...
//ID Card
    ...
    public com.Printing.Marks printMarksMulti(String[] title, String[] IDs, int grade, String term, String outFile, Extention ext) throws JRException, Exception {
        ...
        String[][] sqlArray = new String[IDs.length][AllSubjects.length + 4];
        ...
        Sql.insertData(term, sqlArr, table, CONN);
...
//            System.out.println("Read = " + BarCode.read(barCode.getAbsolutePath()));
            ...
            try {
                switch (selection) {
                    ...
                    case "ID Card":
                        ...
                        idc.Print();
                        break;
                    case "Students Detailes":
                        HashMap map = new HashMap();
                        map.put("SCHOOL_IMAGE", School.getName());
                        map.put("BADGE", School.getBadge());
    ...
    public void load(String[] ids) {
        ...
        if (ids.length == 1) {
            ...
            id = Decryption.Character_Seq + Decryption.Id;
            fileName = id + Decryption.Character_Seq + Decryption.Name;
            setImage(LImage, gsi(Left), id);
            setImage(RImage, gsi(Right), id);
        }
        idbox1.setText(id);
    ...
    private void RightActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RightActionPerformed
        try {
            File img = new File(getDecrypted(Right.getSelectedItem().toString(), idbox1.getText()));
            if (img.exists()) {
    ...
    public File setImage(JLabel l, String s, String id) {
        ...
        try {
            ...
            if (!i.exists()) {
                r = File.createTempFile(s, ".png");
                ImageIO.write(ImageWriter.getImage(img), "png", r);
            } else {
                r = i;
            }
            UI.setImage(img, l);
...
//Leaving Report
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Logger.getLogger(Manage_frame.class.getName()).log(Level.SEVERE, null, ex);
        }
